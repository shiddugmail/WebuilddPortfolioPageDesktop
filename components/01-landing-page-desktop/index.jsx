        ...
        <div className="lpd-frame-1570">
          <div className="lpd-overlap-group">
                ...
                <div className="lpd-group-37">
                  <div className="lpd-overlap-group2">
                    ...
                    <div className="lpd-frame-16">
                      <div className="lpd-text-1 lpd-valign-text-middle animate-enter1">
                        <span>
            ...
            <div className="lpd-group-108">
              <h1 className="lpd-title lpd-valign-text-middle typographyheadlineh2-extrabold-40">{whyWebuild}</h1>
            ...
            <Group273
              ...
              className={group273Props.className}
            />
            <Group273
...
function GetAQuoteButton22(props) {
  ...
  return (
    <div className="lpd-x2607547 animate-enter2 component lpd-component-wrapper not-ready">
      <div className="lpd-master-button-0sW4MC">
        <div className="lpd-button-i260754751-V82dLG lpd-valign-text-middle">{children}</div>
      </div>
    </div>
  );
}
...
function Frame29(props) {
  ...
  return (
    <div className="lpd-frame-29-1">
      <div className="lpd-text-4 lpd-valign-text-middle typographyheadlineh4-extrabold-24">{text9}</div>
...
function Frame292(props) {
  ...
  return (
    <div className="lpd-frame-29-2">
      <div className="lpd-text-8 lpd-valign-text-middle typographyheadlineh4-extrabold-24">{text13}</div>
...
function Frame293(props) {
  ...
  return (
    <div className="lpd-frame-29-3">
      <div className="lpd-text-6 lpd-valign-text-middle typographyheadlineh4-extrabold-24">{text11}</div>
...
function Group109(props) {
  ...
  return (
    <div className={`lpd-group-109 ${className || ""}`}>
      <div className="lpd-our-projects lpd-valign-text-middle typographyheadlineh2-extrabold-40">{ourProjects}</div>
      <p className="lpd-text lpd-valign-text-middle typographybody16-regular">{text21}</p>
    </div>
  );
}
...
function Group99(props) {
  ...
  return (
    <div className="lpd-group-99">
      <div className="lpd-text-1-1 lpd-valign-text-middle typographyheadlineh4-extrabold-24">{text1}</div>
...
function Button22(props) {
  ...
  return (
    <div className="lpd-x2607791 component lpd-component-wrapper not-ready">
      <div className="lpd-master-button-gAXIb9">
        <div className="lpd-button-i260779151-GqONSi lpd-valign-text-middle">{children}</div>
      </div>
    </div>
  );
}
...
function PackageCard(props) {
  ...
  return (
    <div className="lpd-package-card">
      <div className="lpd-text-24 lpd-valign-text-middle typographyheadlineh4-extrabold-24">{text64}</div>
...
function Group69(props) {
  ...
  return (
    <div className="lpd-group-69">
      <div className="lpd-number lpd-valign-text-middle typographyheadlineh2-extrabold-40">{number}</div>
      <div className="lpd-text-2-1 lpd-valign-text-middle typographybody16-regular">{text4}</div>
    </div>
  );
}
...
function Button8(props) {
  ...
  return (
    <div className="lpd-i26012314-66600 component lpd-component-wrapper not-ready">
      <div className="lpd-master-button-4KxvdI">
        <div className="lpd-button-i2601231466-hdozzc lpd-valign-text-middle">{children}</div>
      </div>
    </div>
  );
}
...
function Group111(props) {
  ...
  return (
    <div className="lpd-group-11">
      <div className="lpd-basic-i2601231 lpd-valign-text-middle typographyheadlineh4-extrabold-24">{basicI2601231166}</div>
      ...
      <div className="lpd-overlap-group-1">
        ...
        <div className="lpd-group-120">
          ...
          <div className="lpd-flex-col-1">
            <div className="lpd-name lpd-valign-text-middle typographyheadlineh3-extrabold-30">{name}</div>
            <div className="lpd-text-5-2 lpd-valign-text-middle typographybody16-regular">{text279}</div>
          </div>
        </div>
      </div>
    </div>
...
function Group114(props) {
  ...
  return (
    <div className="lpd-group-114">
      <div className="lpd-cost-estimator lpd-valign-text-middle typographyheadlineh2-extrabold-40">{costEstimator}</div>
      <p className="lpd-text-58 lpd-valign-text-middle typographybody16-regular">{text69}</p>
    </div>
  );
}
...
function EstimateNowButton(props) {
  ...
  return (
    <div className="lpd-x26012333 component lpd-component-wrapper not-ready">
      <div className="lpd-master-button-vdtmmz">
        <div className="lpd-button-i2601233351-k5Tboy lpd-valign-text-middle">{children}</div>
      </div>
    </div>
  );
}
        ...
        <div className="lpd-frame-27">
          <div className="lpd-selected">
            <div className="lpd-overlap-group1-3">
              ...
              <div className="lpd-place-2 lpd-valign-text-middle overpass-bold-shark-14px">{place}</div>
            </div>
          </div>
          <div className="lpd-unselected-i2601234 lpd-valign-text-middle typography-body-smalltext-14-regular">
            {unselectedI2601234}
          </div>
          {/* <img className="lpd-projects" > {projects} </img> */}
          <div className="lpd-projects lpd-valign-text-middle typography-body-smalltext-14-regular">
            {projects}
          </div>
          <div className="lpd-unselected-i2601234-1 lpd-valign-text-middle typography-body-smalltext-14-regular">
            {unselectedI26012342}
          </div>
          <div className="lpd-unselected-i2601234-2 lpd-valign-text-middle typography-body-smalltext-14-regular">
            {unselectedI26012343}
          </div>
          <div className="lpd-unselected-i2601234-3 lpd-valign-text-middle typography-body-smalltext-14-regular">
            {unselectedI26012344}
          </div>
          <div className="lpd-unselected-i2601234-4 lpd-valign-text-middle typography-body-smalltext-14-regular">
            {unselectedI26012345}
          </div>
          <div className="lpd-unselected-i2601234-5 lpd-valign-text-middle typography-body-smalltext-14-regular">
            {unselectedI26012346}
          </div>
        </div>
...
function GetAQuoteButton222(props) {
  ...
  return (
    <div className="lpd-i26012349-64120 component lpd-component-wrapper not-ready">
      <div className="lpd-master-button-FifxVR">
        <div className="lpd-button-i2601234964-yyNXsM lpd-valign-text-middle">{children}</div>
      </div>
    </div>
  );
}
    ...
    <div className="lpd-group-32">
      <div className="lpd-group-189">
        <div className="lpd-map-pin-1">
          <div className="lpd-overlap-group1-5">
            <img
        ...
        <p className="lpd-text-26 typographybody16-regular">
      ...
      <div className="lpd-group-18">
        <div className="lpd-phone">
          <img
            ...
            src="https://anima-uploads.s3.amazonaws.com/projects/60c1b397ba70f9d1bdda22ff/img/vector-168@2x.svg"
          />
        </div>
        <div className="lpd-text-2-2 lpd-valign-text-middle typographybody16-regular">+91 8976535221, +91 8755645342</div>
      </div>
      <div className="lpd-group-18">
        <div className="lpd-mail">
          <div className="lpd-overlap-group1-6">
            <img
        ...
        <div className="lpd-text-2-2 lpd-valign-text-middle typographybody16-regular">contact@webuild.com</div>
      </div>
    </div>
  );
}
...
function Frame53(props) {
  ...
  return (
    <div className="lpd-frame-5">
      <div className="lpd-text-29 lpd-valign-text-middle typographyheadlineh5-extrabold-20">{text40}</div>
      <Frame4
...
function Frame4(props) {
  ...
  return (
    <div className="lpd-frame-4">
      <div className="lpd-text-10 lpd-valign-text-middle typographybody16-regular">{text41}</div>
      <div className="lpd-text-11 lpd-valign-text-middle typographybody16-regular">{text42}</div>
      <div className="lpd-text-11 lpd-valign-text-middle typographybody16-regular">{text43}</div>
      <div className="lpd-text-11 lpd-valign-text-middle typographybody16-regular">{text44}</div>
      <div className="lpd-text-11 lpd-valign-text-middle typographybody16-regular">{text45}</div>
      <div className="lpd-text-11 lpd-valign-text-middle typographybody16-regular">{text46}</div>
      <div className="lpd-text-11 lpd-valign-text-middle typographybody16-regular">{text47}</div>
    </div>
  );
}
...
function Frame6(props) {
  ...
  return (
    <div className="lpd-frame-6">
      <div className="lpd-text-37 lpd-valign-text-middle typographyheadlineh5-extrabold-20">{text48}</div>
...
function Frame42(props) {
  ...
  return (
    <div className={`lpd-frame-4-1 ${className || ""}`}>
      <div className="lpd-text-38 lpd-valign-text-middle overpass-extra-bold-white-16px">{text49}</div>
      <div className="lpd-frame-1580">
        <div className="lpd-text-12 lpd-valign-text-middle typographybody16-regular">{text50}</div>
        <div className="lpd-place-3 lpd-valign-text-middle typographybody16-regular">{place}</div>
        <div className="lpd-text-40 lpd-valign-text-middle typographybody16-regular">{text51}</div>
        <div className="lpd-text-41 lpd-valign-text-middle typographybody16-regular">{text52}</div>
      </div>
    </div>
  );
}
...
function Frame7(props) {
  ...
  return (
    <div className="lpd-frame-7">
      <div className="lpd-text-45 lpd-valign-text-middle typographyheadlineh5-extrabold-20">{text56}</div>
      <Frame4
        text41={frame4Props.text41}
        text42={frame4Props.text42}
        text43={frame4Props.text43}
