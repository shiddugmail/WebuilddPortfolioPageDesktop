...
import Group2722 from "../Group2722";
import Group129 from "../Group129";
import Frame165 from "../Frame165";
import Footer from "../Footer";
import "./X01LandingPageTablet.css";

function X01LandingPageTablet() {
  return (
      <div className="container-center-horizontal">
        <div className="lpt-x01-landing-pagetablet screen">
          <div className="lpt-overlap-group">
            <Frame144 group86Props={frame144Data.group86Props} iconMenuProps={frame144Data.iconMenuProps} />
            <div className="lpt-frame-16">
              <p className="lpt-text-8 valign-text-middle overpass-semi-bold-white-16px2">
                <span>
                  <span className="lpt-span0 overpass-semi-bold-white-16px-22">
                    Gain the Power of “Unified C2C” <br />
                    Unburden yourself while
                  </span>
                  <span className="lpt-span1 overpass-semi-bold-white-32px">
                    {" "}
                    <br />
                  </span>
                  <span className="lpt-span2-1 overpass-extra-bold-mahogany-40px">we build your future.</span>
                </span>
              </p>
              <p className="lpt-text-9 typography-body-smalltext-14-regular">
                At Webuilld we offer you a completely
                <br />
                “Unified Conception to Construction” value proposition.&nbsp;&nbsp;No more dealing with a dozen
                sub-contractors or labour hassles when constructing your home or commercial building
              </p>
              <GetAQuoteButton2>GET A QUOTE</GetAQuoteButton2>
            </div>
          </div>
          <div className="lpt-why-webuild valign-text-middle typographyheadlineh4-extrabold-24">Why Webuild?</div>
          <p className="lpt-text-1 typography-body-smalltext-14-regular">
            Because we bring to the table XX years of comprehensive experience, XX happy customers blended with
            trust, reliability and transparency
          </p>
          <div className="lpt-group-144">
            <img
            ...
            />
            <div className="lpt-group-143">
              <div className="lpt-building">
                <div className="lpt-overlap-group2-8">
                  <div className="lpt-group-3"></div>
                  <img
              ...
              <div className="lpt-text-2 valign-text-middle typographyheadlineh5-extrabold-20">
                The Webuildd Difference
              </div>
              <p className="lpt-text-3 typographybodysmall-12-regular">
                <span className="lpt-span typographybodysmall-12-regular">
                  What makes us stand miles apart from other firms? We call it “Webuildd Difference”: from the very
                  first time you meet us, to the interaction with our team, the hassle-free engagement and finally
                  the day we hand you the keys to your new home/building, the only standard we accept for ourselves
                  (and our customers) is “Consistent Excellence”. We are never satisfied with our laurels, and our
                  service to you goes far beyond simply putting one brick on top of another. We not only ensure that
                  get quality, but also blend it with creativity, engineering, management, quality and multiple
                  other disciplines to deliver the perfect output for your residential or commercial needs. We have
                  even created our very own
                </span>
                <span className="lpt-span-1 typographybodysmall-12-regular">
                  {" "}
                  <br />
                </span>
                <span className="lpt-span2 overpass-semi-bold-mahogany-12px">cost estimator</span>
                <span className="lpt-span-1 typographybodysmall-12-regular">&nbsp;</span>
                <span className="lpt-span typographybodysmall-12-regular">
                  that helps you calculate your probable capital outgo for your upcoming building. We really like to
                  make things easy for our clients
                </span>
              </p>
            </div>
          </div>
          <div className="lpt-group-142">
            <img
              className="lpt-rectangle-7"
              src="https://anima-uploads.s3.amazonaws.com/projects/60c1b397ba70f9d1bdda22ff/img/rectangle-73-1@1x.png"
            />
            <div className="lpt-group-145">
              <div className="lpt-blueprint">
                <div className="lpt-overlap-group2-9">
                  <img
              ...
              <div className="lpt-text-4 valign-text-middle typographyheadlineh4-extrabold-24">
                Why Choose Us? Minimum Hassles. Maximum Value
              </div>
              <p className="lpt-text-5 typography-body-smalltext-14-regular">
                We possess third generation business continuity which is a rarity. Which means that you gain decades
                of collaborative experience to your benefit. Expertise, quality, transparency, reliability and cost
                effectiveness are why our customers come back to us again and again. We offer a perfect blend of all
                these factors resulting in deep customer delight. We put the “Smart” in everything that we do.
                Smarter design, smarter spaces, smarter value. Simply: smarter living. With exciting options and
                construction plans to choose from, one is certain to be right for you. Yes, other people do some of
                what we do, but no one does everything in the unique way we do.
              </p>
            </div>
          </div>
          <img
          ...
          />
          <div className="lpt-group-146">
            <div className="lpt-plan">
              <div className="lpt-overlap-group2-6">
                <div className="lpt-overlap-group3-1">
                  <img
            ...
            <div className="lpt-text-6 valign-text-middle typographyheadlineh4-extrabold-24">
              Our Customer Value Propositions
            </div>
            <p className="lpt-text-7 typography-body-smalltext-14-regular">
              When it comes to building a new residential or commercial building, choosing the right partner to
              bring your vision to life is an important first step. Our experienced Webuildd team has all the
              expertise, resources, and connections you need to turn inspiration into reality with seamless ease.
              You don’t have to deal with the hassles of managing complex coordination and multiple resources. Our
              in-house team has you covered from legal, estimation, site planning, architectural design,
            </p>
          </div>
          <div className="lpt-frame-154">
            <div className="lpt-our-projects valign-text-middle typographyheadlineh4-extrabold-24">Our Projects</div>
            <p className="lpt-text-10 typography-body-smalltext-14-regular">
              We offer an entire array of construction options. Choose from basic to luxury according to your
              requirements
            </p>
            <Frame149 {...frame149Data} />
          </div>
          <Button22>VIEW MORE</Button22>
          <div className="lpt-packages valign-text-middle typographyheadlineh4-extrabold-24">Packages</div>
          <p className="lpt-text-19 typographybody16-regular">
            We offer an entire array of construction options. Choose from basic to luxury according to your
            requirements
          </p>
          <div className="lpt-frame-158">
            <div className="lpt-frame-156">
              <PackagesCard
                basic="Basic"
            ...
            <div className="lpt-frame-157">
              <Group112 {...group112Data} />
              <Group113
                basic="Luxury"
          ...
          <div className="lpt-overlap-group1">
            <div className="lpt-frame-162">
              <div className="lpt-overlap-group2-7">
                <div className="lpt-cost-estimator-bg">
                  <div className="lpt-rectangle-63"></div>
                </div>
                <Group11422
                ...
                />
                <EstimateNowButton>ESTIMATE NOW</EstimateNowButton>
                <Group11722
            ...
            <div className="lpt-frame-166">
              <div className="lpt-overlap-group3-2">
                <div className="lpt-frame-160">
                  <div className="lpt-frame-159">
                    <div className="lpt-frame-37">
                      <img
                ...
                />
                <Group129 />
                <p className="lpt-text-26 typographybody16-regular">
                  Listen to what our customers say about us. They are the beating heart of our business
                </p>
                <div className="lpt-testimonials valign-text-middle typographyheadlineh4-extrabold-24">
                  Testimonials
                </div>
              </div>
            </div>
...
export default X01LandingPageTablet;
